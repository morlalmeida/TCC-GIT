function [ObjVals,pitch] = evaluate_fitness(x)
    %% Load Global Parameters
    global Vs MTOW;

    %% Setting Initial Parameters    
    M = 2; % Number of objectives
    ObjVals = [1e6; 1e6]; % Default infeasible output
    ...
    try
        ...
        if isempty(fspeed) || length(fspeed) < 1
            fspeed_true = NaN;
            return
        ...
        ObjVals= [-thrust_index; -(fspeed_true / Vs)]; % Maximizing thrust &  Maximizing flight speed ratio
